...
Then implement working code (HTML/CSS/JS, React, Angular, etc.) that is:
...
- stores
- authentication
  -- complex Angular logic
  -- advanced reactivity
  -- services unless explicitly requested

-The goal is to help the developer learn Angular concepts manually.

Therefore:

- keep Angular logic intentionally simple
- focus on visual implementation
- prefer static mock data
- avoid overengineering
- prioritize clean UI over complex architecture
...
- use distinctive layouts and typography
- have strong visual hierarchy
- use elegant spacing and composition
